...
const segmentStyles = tv({
	base: "inline p-0.5 type-literal:px-0 rounded outline forced-color-adjust-none caret-transparent text-gray-800 dark:text-zinc-200 forced-colors:text-[ButtonText]",
	variants: {
		isPlaceholder: {
